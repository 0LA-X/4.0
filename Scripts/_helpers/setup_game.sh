...
DEPS=(
  # ==  [Install Dependencies/ 32bit Libraries]
  ...
  libjpeg-turbo lib32-libjpeg-turbo libxcomposite lib32-libxcomposite  lib32-freetype2
  libxinerama lib32-libxinerama ncurses lib32-ncurses opencl-icd-loader lib32-opencl-icd-loader 
  libxslt lib32-libxslt libva lib32-libva gtk3 lib32-gtk3 lib32-libxml2 lib32-sdl2 
